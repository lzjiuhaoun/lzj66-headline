...
import cn.lzj66.headline.dao.NewsHeadlineDao;
...
public class NewsHeadlineDaoImpl extends BaseDao implements NewsHeadlineDao {
    ...
    public HeadlineDetailVo findHealineDetail(int hid) {
        String sql = "select h.hid hid , h.title title , h.article article , h.type type , t.tname typeName , h.page_views pageViews , TIMESTAMPDIFF(HOUR,h.create_time,now() )pastHours , h.publisher publisher , u.nick_name author from news_headline h left join news_type t on h.type = t.tid left join news_user u on h.publisher = u.uid where h.hid = ?";
